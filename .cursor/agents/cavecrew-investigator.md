...
description: Read-only code locator. Returns file:line table for where X is defined, what calls Y, list uses of Z. Caveman-compressed output (~60% fewer tokens than Explore). Refuses to suggest fixes.
model: inherit
readonly: true
---
